...
import numpy as np
import pickle
from keras._tf_keras.keras.applications.resnet50 import preprocess_input # type: ignore
from keras._tf_keras.keras.applications.resnet50 import ResNet50 # type: ignore
from keras._tf_keras.keras.preprocessing import image # type: ignore
